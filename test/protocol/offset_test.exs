defmodule Cafex.Protocol.Offset.Test do
  ...
  test "parse_response correctly parses a valid response with an offset" do
    ...
    expected_response = [%Cafex.Protocol.Offset.Response{partition_offsets: [%{error_code: 0, offset: '\n', partition: 0}], topic: "bar"}]

    assert expected_response == Cafex.Protocol.Offset.parse_response(response)
  end
  ...
  test "parse_response correctly parses a valid response with multiple offsets" do
    ...
    expected_response = [%Cafex.Protocol.Offset.Response{partition_offsets: [%{error_code: 0, offset: [10, 20], partition: 0}], topic: "bar"}]
  ...
  test "parse_response correctly parses a valid response with multiple partitions" do
    ...
    expected_response = [%Cafex.Protocol.Offset.Response{partition_offsets: [
  ...
  test "parse_response correctly parses a valid response with multiple topics" do
    ...
    expected_response = [
      %Cafex.Protocol.Offset.Response{partition_offsets: [%{error_code: 0, offset: [10], partition: 0}], topic: "bar"},
      %Cafex.Protocol.Offset.Response{partition_offsets: [%{error_code: 0, offset: [20], partition: 0}], topic: "baz"}
    ]
