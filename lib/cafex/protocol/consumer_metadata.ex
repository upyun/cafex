defmodule Cafex.Protocol.ConsumerMetadata do
  ...
  def create_request(correlation_id, client_id, consumer_group \\ "cafex") do
    Cafex.Protocol.create_request(:consumer_metadata, correlation_id, client_id) <> << byte_size(consumer_group) :: 16-signed, consumer_group :: binary >>
  end
